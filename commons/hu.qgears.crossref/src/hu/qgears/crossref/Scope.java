...
public class Scope {
	 ...
	 * subtypes then all possible subtypes must be used here. This is because the type is searched for exact match for performance reasons. 
	...
	public void setPossibleTypes(String[] targetType) {
		if(sealed)
		{

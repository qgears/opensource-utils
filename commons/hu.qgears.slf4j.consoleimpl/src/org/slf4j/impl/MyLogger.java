...
public class MyLogger implements Logger {
	...
	private void fmt(Level severe, Marker marker, String msg) {
		if(severe.intValue()>=level)
		{
			LogOutput.fmt(severe, marker, ""+name+": "+msg);
		}
	}
